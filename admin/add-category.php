                    ...
                    <form action="code.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" placeholder="Enter Car Type Name" class="form-control">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <label for="" class="fw-bold">Meta Title</label>
                            ...
                            <div class="col-md-12">
                                <label for="" class="fw-bold">Meta Keywords</label>
                                <textarea rows="3" name="meta_keywords" placeholder="Enter Meta Keywords" class="form-control"></textarea>
                            </div>
                            <div class="col-md-6">
                                <label for="" class="fw-bold">Inactive</label>
                                <input type="checkbox" name="status">
                            </div>
                            <div class="col-md-12">
                                <label for="" class="fw-bold">What's New?</label>
