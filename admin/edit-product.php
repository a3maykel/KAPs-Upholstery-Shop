                                ...
                                <div class="card-body">
                                    <form action="code.php" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <label class="mb-0">Percent Discount</label>
                                                <input type="text" required name="discount" value="<?= $data['discount'] ? $data['discount'] . '%' : '0%'; ?>" placeholder="Discount" class="form-control mb-2">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="mb-0">Selling Price</label>
                                                <input type="number"  name="selling_price" value="<?= $data['selling_price']; ?>" placeholder="Selling Price" class="form-control mb-2" readonly>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="mb-0">Inactive</label> <br>
                                                    <input type="checkbox" name="status" <?= $data['status'] == '0'?'':'checked'  ?> >
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="mb-0">What's New?</label> <br>
